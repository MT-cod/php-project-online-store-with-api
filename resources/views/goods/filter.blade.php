...
@endif
        <form class="text-center" id="fsp" method="GET" action="/goods" accept-charset="UTF-8">
            ...
            @include('shared.filter.by_category')

            @include('shared.filter.by_name')

            @include('shared.filter.by_slug')

            @include('shared.filter.by_price')

            @include('shared.filter.by_created_time')

            @include('shared.filter.by_updated_time')

            @include('shared.filter.by_additional_chars')

            <div class="btn-block g-0">
                <a href="/goods/?filter_expand=1" style="text-decoration: none">
