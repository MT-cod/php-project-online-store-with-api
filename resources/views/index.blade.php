...
<div class="container-fluid" style="height: 95vh !important; background: url(/back_gray.jpg) repeat">

    <div class="row justify-content-center">
        <h3 class="display-10">Online store</h3>
    </div>

    <div class="row text-center" style="background-color: rgba(189,189,189,0.35)">
        <div class="col-3"><h2>Фильтр</h2></div>
        <div class="col-8"><h2>Товары</h2></div>
        <div class="col-1 text-left">
            @guest
                <button type="button" class="btn btn-success" onclick="return alert('Для создания товара необходимо авторизоваться!')">Корзина</button>
            @else
                <button class="btn btn-success btn-modal_goods_create" data-toggle="tooltip" data-placement="bottom" title="Создать новый товар">Корзина</button>
            @endguest
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-3 text-center" style="max-height:90vh !important; overflow-y:scroll !important;">
            <form class="center m-md-3 p-md-3" method="GET" action="/" accept-charset="UTF-8">
